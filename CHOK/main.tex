...
\begin{enumerate}
	...
	\item  A Választmány alelnökei
		...
		\end{enumerate}	
		\item a külügyi alelnök 
			\begin{enumerate}	
				\item figyelemmel kíséri a Választmány és a 7. § 2. b.-ben meghatározott fórumok munkáját, kapcsolatot tart fent a Collegium és jelen szervek között, illetve szükség esetén elsősorban ő helyettesíti az elnököt ezen fórumokon,
				\item az Elnök akadályoztatása esetén a Választmány delegáltja a KolHÖK küldöttgyűlésébe.
			\end{enumerate}
		\end{enumerate}
